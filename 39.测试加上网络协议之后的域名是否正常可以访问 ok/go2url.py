...
def insertDB(content):
    ...
    try:
        ...
        cursor.executemany('insert into check_domain_1w (url,redirect_url,status_code,title) values (%s,%s,%s,%s)', content)
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
    except TypeError :
...
# create table check_domain_1w (id int not null primary key auto_increment,
# url  varchar(255),
# redirect_url  varchar(255),
# status_code  varchar(255),
# title  varchar(255),
